...
def getArgs():
    ...
    if args.pathName is None:
        print("Must specify path in which directory" + " to parse is located using -p")
        sys.exit(1)
...
def main():
    pathName = "D:\\1110\\8db6c32"#getArgs()""
    # srcFiles = lizard.get_all_source_files("D:\\1110\\8db6c32", [], [])
    srcFiles =lizard.get_all_source_files("D:\\1110\\8db6c32", exclude_patterns=None, lans='java');
